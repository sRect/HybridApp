...
(function() {
    ...
    viewerSearchNameSpace.InViewerSearchMain.prototype.activate = function() {
        if(!this.activeStatus) {
            this.inViewerSearchPanel.setVisible(true);
            this.activeStatus = true;
        }
        return true;
    };

    viewerSearchNameSpace.InViewerSearchMain.prototype.deactivate = function() {
        if(this.activeStatus) {
            this.inViewerSearchPanel.setVisible(false);
...
(function() {
    ...
    InViewerSearchExtension.prototype.activate = function () {
        if(!this.activeStatus) {
            this.inViewerSearchMain.activate();
            this.activeStatus = true;
        }
        return true;
    };

    InViewerSearchExtension.prototype.deactivate = function () {
        if(this.activeStatus) {
            this.inViewerSearchMain.deactivate();
            this.activeStatus = false;
        }
        return true;
    };

    InViewerSearchExtension.prototype.isActive = function () {
...
(function() {
    ...
    function createRecentQueriesUI(self, container, hideTitle) {
        ...
        listDom.className = 'recent-searches-list docking-panel-scroll';
    ...
    function createSavedQueriesHtml(self, data, container) {
        ...
        queriesList.className = "saved-queries-list docking-panel-scroll";
...
(function() {
    ...
    viewerSearchNameSpace.InViewerSearchSettingsPanel.prototype.createContainers = function(setAllocationLabelTextfn) {
        ...
        documentsQueriesHTML.className = "all-document-queries docking-panel-scroll";
...
(function() {
    ...
    function createContainersAndList(self, container, str, geometryResults, geometry, totalNumberOfResults, allLoaded, index) {
        ...
        geometriesContainerDom.className = 'geometries-results-container docking-panel-scroll';
    ...
    function showNoResults(container, str, contextName) {
        ...
        noResultsDom.textContent = av.i18n.translate('No Results for', { '0': str, '1': contextName });
...
(function() {
    ...
    function showNoResults(container, str, contextName) {
        ...
        strResultText = av.i18n.translate('No Results for', { '0': str, '1': contextName });
    ...
    viewerSearchNameSpace.InViewerSearchThisProject.prototype.showResults = function(str, results) {
        ...
        if (ctrl.count > 0) {
            ...
            categoriesContainerDom.className = 'categories-results-container docking-panel-scroll';
        ...
        if (length) {
            if (self.options.uiEnabled) {
                ...
                if (!self.resultList) {
                    ...
                    self.resultList.className = 'search-result-list docking-panel-scroll';
...
(function() {
    ...
    var maxGeometriesToLoad = 300; //we don麓t load more than 300 geometries to prevent memory crash
    var geometriesCache = {};
